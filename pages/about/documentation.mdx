...
When you are ready to host your project online, you need to set the `NEXT_PUBLIC_URL` environment variable to the URL of your site. This is used to generate the canonical URL for each page.
