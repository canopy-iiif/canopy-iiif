...
This page is output from the `/content/about/documentation.mdx` file. See the [Markdown Example](https://canopy-iiif.github.io/canopy-iiif/about/example) page for additional information.
